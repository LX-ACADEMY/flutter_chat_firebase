...
def hello(req: https_fn.Request) -> https_fn.Response:
    if req.method == "POST":
        ...
        return https_fn.Response(dumps(output), status=200,
...
def send_notification(req: https_fn.Request) -> https_fn.Response:
    try:
        ...
        if 'device_token' not in req_body:
            return https_fn.Response("Invalid request body. "
        ...
        # This is required because FCM requires the data parameter to
        # be a dictionary
        ...
        return https_fn.Response("Message sent successfully."
